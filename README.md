# Behind Traditional Values:Confucian Clans and the Historical Trajectory of Chinese Financial Development
...
), containing data, 'R' scripts and a final 'PDF' report ([link here](/outputs/paper/paper.pdf)). This is research underscores the significance of cultural influence on economic development.
